...
const
  External_YSL_POS_DLL = 'ConnYSL.dll';   //Delphi 2007写的dll
  ...
  function YSL_ClosePort: Boolean; stdcall
    ; external External_YSL_POS_DLL;
  function YSL_ReadCard(var cCard: AnsiString; var Balance: Currency): Byte; stdcall
    ; external External_YSL_POS_DLL;
  function YSL_Consume(cCard: AnsiString; cPay: Currency; iFlow: Byte; var Balance, cPayEx: Currency): Byte; stdcall
    ; external External_YSL_POS_DLL;
  function YSL_ConsumeEx(cCard: AnsiString; cPay: Currency; iFlow: Byte; var Balance, cPayEx: Currency): Byte; stdcall
    ; external External_YSL_POS_DLL;
  function YSL_Query(cCard: AnsiString; cPay: Currency; iFlow: Byte; var Balance, cPayEx: Currency): Byte; stdcall
    ; external External_YSL_POS_DLL;
